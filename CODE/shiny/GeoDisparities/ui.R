...
shinyUI(navbarPage(title = img(src="mod.jpg", height = "40px"), id = "navBar",
                   ...
                   collapsible = TRUE,
                   inverse = TRUE,
                   windowTitle = "March of Dimes Preterm Birth GeoDisparities Mapper",
                   position = "fixed-top",
                   footer = includeHTML("./www/include_footer.html"), # ------------------------------- TO DO
                   header = tags$style(
                     ".navbar-right {
                   ...
                   tabPanel("HOME", value = "home",
                            ...
                            fluidRow(
                              HTML("
                                   ...
                                   <h2 class='parallax'>Preterm Birth GeoDisparities Mapper</h2>
