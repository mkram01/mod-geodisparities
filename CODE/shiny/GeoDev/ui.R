...
# Code objective: MoD GeoDisparities web tool - User interface for dev app
# Date: 1.8.2019
#############################################
                            ...
                            sidebarLayout( 
                              ...
                              sidebarPanel( width = 3,
                                            ...
                                            tags$div(
                                              ...
                                              #select geography
                                              introBox(
                                                selectizeInput("geolevel", "Select your geography level",
                                                               choices = c("National", "Subnational"),
                                                               selected = "National",
                                                               multiple = FALSE),
                                                data.step = 1,
                                                data.intro = "Start by picking whether you would like a National or a Subnational (select States next) view of the US"
                                                
                                              ),
                                              
                                              introBox(
                                                conditionalPanel("input.geolevel=='Subnational'",
                                                                 selectizeInput("state", "Select your state(s) of interest",
                                                ...
                                                data.step = 2,
                                                data.intro = "If you've selected Subnational in the previous step, now pick the state(s) you would like to view!"
                                              ...
                                              introBox(
                                                selectizeInput("modvar", "Select your model variable",
                                                               choices = model_vars,
                                                               selected = "Preterm birth, Total"
                                                                ),
                                                data.step = 3,
                                              ...
                                              introBox(
                                                selectizeInput("contextvar", "Select your contextual variable",
                                                               context_vars, 
                                                               selected = "% Poverty"),
                                                data.step = 4,
                                              ...
                                              conditionalPanel("input.modvar %in% mod_continuousvars",
                                              ...
                                              conditionalPanel("input.contextvar %in% context_continuousvars",
                                              ...
                                              #select year
                                              sliderInput('year', label = "Year", value = max(appdata$year), 
                                                          min = min(appdata$year), max = max(appdata$year), 
                                                          step=1, sep = ""
                              ...
                              mainPanel( width = 8,
                                         ...
                                         fluidRow(
                                           ...
                                           column(6,
                                                  plotlyOutput("modscatter")
                                           ),
                                           column(6,
                                                  plotlyOutput("contextscatter")
                                           )
                                         ),
