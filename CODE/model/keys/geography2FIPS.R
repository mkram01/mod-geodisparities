...
# Code objective: mapping geography defined in config to vector of 2-digit FIPS codes
# Date: 5.7.2019
#############################################
...
suppressWarnings(
  if(geography == "all"){
    ...
    geo_fips <- c("01", "02", "04", "05", "06", "08", "09", "10", "11", "12", "13", "15", "16",
                  ...
                  "44", "45", "46", "47", "48", "49", "50", "51", "53", "54", "55", "56") #72 = Puerto Rico, not currently included
  }
)
